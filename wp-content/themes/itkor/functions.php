...
function i_register_types(){
    ...
    register_post_type( $post_type1, [
        'labels' => [
            'name'               => 'Совет директоров института ИТКОР', // основное название для типа записи
            'singular_name'      => 'Совет директоров института ИТКОР', // название для одной записи этого типа
            ...
            'menu_name'          => 'Совет директоров', // название меню
        ],
        'public'              => true,
        'menu_position'       => 4,
